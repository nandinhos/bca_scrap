-- ===========================================
-- SEEDS - Dados Iniciais do Sistema BCA
-- GAC-PAC/COPAC
-- ===========================================
...
('CAA', '48abd5', 0),
('CEAG', '48abd5', 0)
ON DUPLICATE KEY UPDATE palavra=VALUES(palavra), cor=VALUES(cor);

-- --------------------------------------------------------
-- Seed: Efetivo GAC-PAC/COPAC
-- --------------------------------------------------------
...
ON DUPLICATE KEY UPDATE nome_guerra=VALUES(nome_guerra), nome_completo=VALUES(nome_completo), posto=VALUES(posto), email=VALUES(email);
